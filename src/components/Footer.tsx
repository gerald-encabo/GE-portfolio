                ...
                <div className='footer-container container'>
                    <div className='footer-item-left'>
                        <ul>
                            ...
                            <li className='footer-item-list'><a className='footer-social-media' title="Instagram" href='https://www.instagram.com/iamgeerald/' target='_blank' rel='noreferrer'>Instagram</a></li>
